  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <div className={styles.field}>
        ...
        <input className={styles.input} type="text" name="fullName" placeholder="John Doe" required />
      </div>
      ...
      <div className={styles.field}>
        <label>Phone No. <span className={styles.req}>*</span></label>
        <input className={styles.input} type="tel" name="phone" placeholder="+971 50 000 0000" required />
      </div>

      <div className={styles.grid2}>
        <div className={styles.field}>
          <label>Current Location <span className={styles.req}>*</span></label>
          <select className={styles.select} name="location" required defaultValue="">
      ...
      <div className={styles.field}>
        ...
        <select className={styles.select} name="experience" required defaultValue="">
      ...
      <div className={styles.field}>
        <label>Key Skills <span className={styles.req}>*</span></label>
        <input className={styles.input} type="text" name="skills" placeholder="e.g. Customer service, Sales, Immigration processing" required />
      </div>
      ...
      <div className={styles.field}>
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (picked && picked.size > MAX_UPLOAD_BYTES) {
              setCv(null);
              setCvSizeError(`"${picked.name}" is over 1.5MB — please choose a smaller file.`);
              return;
            }
            setCv(picked);
            setCvSizeError("");
        ...
        <span style={{ fontSize: "0.78rem", color: "#64748B" }}>Max file size 1.5MB</span>
