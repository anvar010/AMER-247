// lucide-react has no WhatsApp glyph (it's a generic icon set, not brand
// icons) — this is the standard WhatsApp mark, filled solid to match how
// brand icons are normally drawn, sized/colored the same way lucide icons
// are used everywhere else in this app (size prop, fill via currentColor).
