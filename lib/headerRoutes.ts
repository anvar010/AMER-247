...
const OPAQUE_FROM_TOP_DESKTOP_ONLY_PREFIXES = ["/pricing-list", "/amer247-services", "/news", "/about", "/online-services", "/uae-tourist-visa", "/contact", "/career", "/payment-status", "/det247-services"];
